...
import 'nutrition_ovulatory_page_model.dart';
export 'nutrition_ovulatory_page_model.dart';

/// Create NutritionOvulatory page.
///
...
/// "✨ Ovulatory" selected background #C9A84C text white.
/// "🌙 Luteal" navigates NutritionLuteal.
...
/// bold size 16 color #2D1B0E. Text "Focus on light anti-inflammatory foods
/// that support peak energy and hormone balance" size 13 color #8B6F5E margin
/// top 8px.
...
/// 🌶️ "Spicy Foods" "Causes inflammation"
/// ☕ "Caffeine" "Disrupts hormones"
/// 🍷 "Alcohol" "Affects ovulation"
/// 🧂 "Salty Foods" "Causes bloating"
...
/// "Breakfast" "Blueberry smoothie bowl with almonds and chia seeds" size 13
/// color #8B6F5E.
/// "Lunch" "Large leafy green salad with edamame and lemon dressing" size 13
/// color #8B6F5E.
/// "Dinner" "Grilled fish with steamed vegetables and brown rice" size 13
/// color #8B6F5E.
...
/// #2D1B0E. Text "Drink coconut water to stay hydrated and support
/// electrolyte balance" size 13 color #8B6F5E.
/// SPACING: Padding 16px. Margin bottom 32px.
class NutritionOvulatoryPageWidget extends StatefulWidget {
  const NutritionOvulatoryPageWidget({super.key});

  static String routeName = 'NutritionOvulatoryPage';
  static String routePath = '/nutritionOvulatoryPage';

  @override
  State<NutritionOvulatoryPageWidget> createState() =>
      _NutritionOvulatoryPageWidgetState();
}

class _NutritionOvulatoryPageWidgetState
    extends State<NutritionOvulatoryPageWidget> {
  late NutritionOvulatoryPageModel _model;
