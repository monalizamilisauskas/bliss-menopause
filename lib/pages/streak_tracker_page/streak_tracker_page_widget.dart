...
import 'streak_tracker_page_model.dart';
export 'streak_tracker_page_model.dart';
...
class StreakTrackerPageWidget extends StatefulWidget {
  const StreakTrackerPageWidget({super.key});

  static String routeName = 'StreakTrackerPage';
  static String routePath = '/StreakTrackerPage';

  @override
  State<StreakTrackerPageWidget> createState() =>
      _StreakTrackerPageWidgetState();
}

class _StreakTrackerPageWidgetState extends State<StreakTrackerPageWidget> {
  late StreakTrackerPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StreakTrackerPageModel());
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          wrapWithModel(
                                            model: _model.milestoneItemModel1,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                          ...
                                          wrapWithModel(
                                            model: _model.milestoneItemModel2,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: MilestoneItemWidget(
                                              isLocked: false,
                                          ...
                                          wrapWithModel(
                                            model: _model.milestoneItemModel3,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: MilestoneItemWidget(
                                              isLocked: true,
                                          ...
                                          wrapWithModel(
                                            model: _model.milestoneItemModel4,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: MilestoneItemWidget(
                                              isLocked: true,
