...
import 'onboarding_quiz1_model.dart';
export 'onboarding_quiz1_model.dart';

class OnboardingQuiz1Widget extends StatefulWidget {
  const OnboardingQuiz1Widget({super.key});

  static String routeName = 'OnboardingQuiz1';
  static String routePath = '/onboardingQuiz1';

  @override
  State<OnboardingQuiz1Widget> createState() => _OnboardingQuiz1WidgetState();
}

class _OnboardingQuiz1WidgetState extends State<OnboardingQuiz1Widget> {
  late OnboardingQuiz1Model _model;
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Container(
                          ...
                          alignment: AlignmentDirectional(0.0, 0.0),
                          child: Lottie.asset(
                            'assets/jsons/Time_management_Lottie_animation.json',
                            width: 160.3,
                            height: 140.5,
                            fit: BoxFit.contain,
                            animate: true,
