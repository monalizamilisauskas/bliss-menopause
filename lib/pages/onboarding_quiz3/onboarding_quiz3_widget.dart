...
import 'onboarding_quiz3_model.dart';
export 'onboarding_quiz3_model.dart';

class OnboardingQuiz3Widget extends StatefulWidget {
  const OnboardingQuiz3Widget({super.key});

  static String routeName = 'OnboardingQuiz3';
  static String routePath = '/onboardingQuiz3';

  @override
  State<OnboardingQuiz3Widget> createState() => _OnboardingQuiz3WidgetState();
}

class _OnboardingQuiz3WidgetState extends State<OnboardingQuiz3Widget> {
  late OnboardingQuiz3Model _model;
